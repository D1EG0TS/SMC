...
<div class="flex justify-start ml-10">
  <img src="{{ asset('resources/img/vitalis.png') }}" class="h-10 w-10 mr-auto">
</div>
  <div class="w-1/2 px-12 mr-auto">
    <p class="text-2xl font-bold">Sistema de Medicion Clinica VITALIS</p>
  </div>
  ...
  <ul class="w-1/2 px-16 ml-auto flex justify-end pt-1">
    ...
    @else
      ...
      <li>
        <a href="{{ route('register.index') }}" class="font-semibold border-2 border-white py-2 px-4 rounded-md hover:bg-white hover:text-indigo-700">Registrate gratis</a>
      </li>
    @endif
  </ul>
</nav>
